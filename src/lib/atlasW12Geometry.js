...
export function calculateAtlasW12Geometry({ lengthM = 20, eaveHeightM = 4.5 } = {}) {
  ...
  const members = {
    ...
    apexHaunch: { code: "W12-APH", label: "Apex and haunch members", quantity: portalFrames * 3, cutLengthM: 1.5, massKgPerM: calculateLippedChannelMassKgPerM(PROFILE.apexHaunch), rule: `${portalFrames} frames × 1 apex member + 2 haunch members` },
  }
