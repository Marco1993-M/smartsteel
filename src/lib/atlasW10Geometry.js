...
export const ATLAS_W10_LENGTHS_M = [4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48]
...
export function calculateAtlasW10Geometry({ lengthM = 20, eaveHeightM = 4.5 } = {}) {
  ...
  if (!ATLAS_W10_LENGTHS_M.includes(length)) throw new Error("W10 length must use 4m bays from 4m to 48m.")
