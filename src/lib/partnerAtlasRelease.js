  ...
  const sheetingDescription = configuration.gableMode === "structure_only"
    ...
    : `${configuration.gableMode === "roof_only"
      ...
      : configuration.gableMode === "fully_enclosed_with_gables"
        ? "fully enclosed with all four walls sheeted"
        : "roof and side walls sheeted"} in ${configuration.sheetingFinish === "chromadek" ? "colour-coated" : "galvanised"} ${configuration.sheetingProfile}`
