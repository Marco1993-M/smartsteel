...
export default function MidrandPage() {
  ...
  widths.forEach(w => {
    lengths.forEach(l => {
      sizes.push(`${w}m x ${l}m warehouse Midrand`);
    });
  });
  ...
  return (
    <main className="font-sans text-gray-800">
      ...
      <section className="relative h-[90vh] flex items-center justify-center text-center text-white">
        ...
        <div className="relative z-10 max-w-4xl px-6">
          ...
          <p className="text-lg md:text-xl mb-8">
            Premium lightweight steel warehouses, factories, and commercial buildings in Midrand.
          </p>
      ...
      <section className="py-20 px-6 max-w-5xl mx-auto">
        <h2 className="text-3xl font-bold mb-6">Steel Structures in Midrand</h2>
        <p className="text-lg mb-4">
          Smart Steel delivers turnkey lightweight steel construction solutions across Midrand and Gauteng.
        </p>
        <p className="text-lg">
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-6">Steel Warehouse Sizes Midrand</h2>
      ...
      {/* PRICING */}
      <section className="py-20 px-6 max-w-5xl mx-auto">
        <h2 className="text-3xl font-bold mb-6">Steel Building Cost Midrand</h2>
        <ul className="space-y-3 text-lg">
      ...
      <section className="bg-black text-white text-center py-20 px-6">
        <h2 className="text-3xl font-bold mb-4">Get a Steel Building Quote in Midrand</h2>
