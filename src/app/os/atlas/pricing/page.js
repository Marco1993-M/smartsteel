  ...
  return (
    <div className="space-y-6 px-4 py-5 sm:px-6 sm:py-6">
      <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
        <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Atlas pricing</p>
        <h3 className="mt-2 text-3xl font-bold tracking-tight text-slate-900">
          Pricing control should live here, not across scattered tools
        </h3>
        <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600">
          This pricing workspace is where Atlas family rates, inclusions, options, and exceptions
          should ultimately be controlled. The goal is to reduce manual drift and make updates easier to trust.
        </p>
      </section>
