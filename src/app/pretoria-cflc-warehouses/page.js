...
export const metadata = {
  ...
  description:
    "Explore CFLC warehouses in Pretoria with Smart Steel. Start the right warehouse enquiry for Gauteng storage, workshop, and industrial projects.",
  keywords: [
...
export default function PretoriaCflcWarehousesPage() {
  return (
    <CflcRegionPage
      ...
      intro="Pretoria remains one of the strongest industrial and storage markets in Gauteng, which makes it a natural fit for a dedicated CFLC warehouse page. If your project needs a clearer cold formed steel option before the quotation is finalised, this is the right place to start."
