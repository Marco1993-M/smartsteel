...
export default function WarehouseDetailPage({ params }) {
  ...
  const [activeImage, setActiveImage] = useState(w.image);
...
<h5 className="text-1xl  mb-4">Explore our FAQs for answers to common questions.
</h5>
    <div className="space-y-4">
      <details className="border rounded-lg p-4 cursor-pointer">
        <summary className="font-semibold">How long does installation take?</summary>
      ...
      <details className="border rounded-lg p-4 cursor-pointer">
        <summary className="font-semibold">What is included in the price?</summary>
        <p className="mt-2 text-gray-700">
      ...
      <details className="border rounded-lg p-4 cursor-pointer">
        <summary className="font-semibold">Do you design and build, or only supply kits?</summary>
        <p className="mt-2 text-gray-700">
      ...
      <details className="border rounded-lg p-4 cursor-pointer">
        <summary className="font-semibold">Can the building be customised?</summary>
        <p className="mt-2 text-gray-700">
      ...
      <details className="border rounded-lg p-4 cursor-pointer">
        <summary className="font-semibold">Do you provide engineering drawings and approvals?</summary>
        <p className="mt-2 text-gray-700">
      ...
      <details className="border rounded-lg p-4 cursor-pointer">
        <summary className="font-semibold">What foundation or slab is required?</summary>
        <p className="mt-2 text-gray-700">
      ...
      <details className="border rounded-lg p-4 cursor-pointer">
        <summary className="font-semibold">Are the buildings suitable for future expansion?</summary>
        <p className="mt-2 text-gray-700">
      ...
      <details className="border rounded-lg p-4 cursor-pointer">
        <summary className="font-semibold">What roof and wall sheeting options are available?</summary>
        <p className="mt-2 text-gray-700">
      ...
      <details className="border rounded-lg p-4 cursor-pointer">
        <summary className="font-semibold">Are your buildings weather-resistant?</summary>
        <p className="mt-2 text-gray-700">
      ...
      <details className="border rounded-lg p-4 cursor-pointer">
        <summary className="font-semibold">Do you build nationwide?</summary>
        <p className="mt-2 text-gray-700">
      ...
      <details className="border rounded-lg p-4 cursor-pointer">
        <summary className="font-semibold">How is pricing calculated?</summary>
        <p className="mt-2 text-gray-700">
      ...
      <details className="border rounded-lg p-4 cursor-pointer">
        <summary className="font-semibold">What is the payment structure?</summary>
        <p className="mt-2 text-gray-700">
      ...
      <details className="border rounded-lg p-4 cursor-pointer">
        <summary className="font-semibold">How long do Smart Steel buildings last?</summary>
        <p className="mt-2 text-gray-700">
      ...
      <details className="border rounded-lg p-4 cursor-pointer">
        <summary className="font-semibold">Can the building be relocated?</summary>
        <p className="mt-2 text-gray-700">
      ...
      <details className="border rounded-lg p-4 cursor-pointer">
        <summary className="font-semibold">Do you offer warranties?</summary>
        <p className="mt-2 text-gray-700">
