...
export default function PartnerDashboard() {
  ...
  const quotes = opportunities
    .filter((item) => ["submitted", "in_review", "quoted"].includes(item.status))
