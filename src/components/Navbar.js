...
export default function Navbar() {
  ...
  // Hover handlers to show one banner at a time
  ...
  />
      ...
      {menuOpen && (
        <div className="md:hidden px-4 pb-4 space-y-2 bg-[#515151] text-white">
          ...
          <Link href="/company" className="block hover:text-[#da1a33]">About</Link>
          <Link href="/for-your-home" className="block hover:text-[#da1a33]">For Your Home</Link>
          <Link href="#contact" className="block hover:text-[#da1a33]">Contact</Link>
        </div>
      )}

      {/* --- BANNERS --- */}

      {/* For Professionals Hover Banner */}
          ...
          <div className="max-w-7xl mx-auto px-8 py-8 grid grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/product-advantages" className="hover:underline">Product Advantages</Link>
                </li>
                <li>
                  <Link href="/resources" className="hover:underline">Technical Resources</Link>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/resources" className="hover:underline">Installation Guides</Link>
                </li>
              </ul>
            </div>
            <div>
      ...
      {showAboutBanner && (
        ...
        >
          <div className="max-w-7xl mx-auto px-8 py-8 grid grid-cols-3 gap-8">
            <div>
              <Link href="/company" className="text-xl font-semibold text-[#da1a33] hover:underline mb-2 block">
                Company
              </Link>
              <p>Learn about our history, mission, and team.</p>
            </div>
            <div>
              <Link href="/sustainability" className="text-xl font-semibold text-[#da1a33] hover:underline mb-2 block">
                Sustainability
              </Link>
              <p>How we build eco-friendly and efficient steel structures.</p>
            </div>
            <div>
              <Link href="/news-events" className="text-xl font-semibold text-[#da1a33] hover:underline mb-2 block">
                News & Events
              </Link>
              <p>Stay updated with the latest company updates and events.</p>
            </div>
          </div>
        </div>
      )}

      {/* For Your Home Hover Banner */}
      {showForHomeBanner && (
        <div
          onMouseEnter={() => handleForHomeHover(true)}
          onMouseLeave={() => handleForHomeHover(false)}
        ...
        >
          <div className="max-w-7xl mx-auto px-8 py-8 grid grid-cols-3 gap-8">
            <div>
              <Link href="/product-advantages" className="text-xl font-semibold text-[#da1a33] hover:underline mb-2 block">
                Product Advantages
              </Link>
            ...
            <div>
              <Link href="/warranty" className="text-xl font-semibold text-[#da1a33] hover:underline mb-2 block">
                Warranty
              </Link>
              <p>10-year structural warranty on all steel frames. Peace of mind guaranteed.</p>
            </div>
            <div>
              <a href="/brochure.pdf" download className="text-xl font-semibold text-[#da1a33] hover:underline mb-2 block">
                Smart Steel Brochure
              </a>
              <p>Download our full product brochure.</p>
              <a href="/brochure.pdf" download className="inline-block mt-4 px-6 py-3 bg-[#da1a33] text-white rounded hover:bg-[#bf172d] transition">
                Download PDF
              </a>
            </div>
          </div>
