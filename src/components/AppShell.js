...
const CHROMELESS_PATHS = ["/partner-demo/", "/kanban/estimates/", "/kanban/invoices/", "/quotes/", "/invoices/", "/estimate-response/", "/os", "/partner"]
...
export default function AppShell({ children }) {
  ...
  return (
    <>
      <Navbar />
      {showBuilderBanner ? (
        <div className="absolute left-0 top-20 z-40 hidden w-full md:block">
          <div className="flex min-h-14 w-full flex-col items-center justify-between gap-2 border-y border-white/25 bg-[#2d63b8]/92 px-4 py-2 text-center text-white shadow-lg backdrop-blur sm:flex-row sm:gap-3 sm:px-6 lg:px-8 sm:text-left">
            ...
            <Link
              ...
              className="inline-flex shrink-0 items-center gap-2 rounded-full bg-[#ffcb13] px-4 py-2 text-sm font-semibold text-black transition hover:bg-[#e9b800] sm:px-5"
            >
              <Image
                src="/3d.png"
                alt=""
