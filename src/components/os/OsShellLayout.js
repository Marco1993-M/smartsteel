  ...
  return (
    <div className="os-shell min-h-screen w-full min-w-0 max-w-[100vw] overflow-x-hidden bg-[linear-gradient(180deg,_#ffffff_0%,_#f8fafc_24%,_#eef3f7_100%)] text-slate-900">
      <div className={`os-shell-grid grid min-h-screen w-full min-w-0 max-w-full transition-[grid-template-columns] duration-300 ${
        ...
        <aside className={`os-shell-sidebar w-full min-w-0 max-w-full overflow-hidden border-b border-white/10 bg-[linear-gradient(180deg,_#0f172a,_#111827)] text-white lg:fixed lg:inset-y-0 lg:left-0 lg:z-40 lg:h-dvh lg:overflow-y-auto lg:border-b-0 lg:border-r print:hidden ${
        ...
        <main className="os-shell-main w-full min-w-0 max-w-full overflow-x-hidden bg-slate-50 lg:col-start-2 print:overflow-visible print:bg-white">
