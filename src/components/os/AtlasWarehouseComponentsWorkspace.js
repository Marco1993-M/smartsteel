...
const W08_COMPONENTS = [
  {
    ...
    section: "2 x 200 x 75 x 20 x 2mm BMT lipped channels, back-to-back",
  ...
  },
  {
    ...
    section: "200 x 75 x 20 x 2.5mm BMT lipped channel",
  ...
  },
  {
    ...
    section: "100 x 50 x 20 x 2mm BMT lipped channel",
  ...
  },
  {
    ...
    section: "Purlins: 175 x 65 x 20 x 2mm; wall and gable girts: 150 x 50 x 20 x 2mm",
    summary: "Roof purlins, side girts, and gable girts calculated independently from building length, height, and sheeting scope.",
    rule: "Roof rows at maximum 1500mm c/c across 4m bays",
    scope: "Standard",
    tags: ["W08", "Purlins", "Wall hats", "Secondary steel"],
    usesLippedChannel: false,
  },
  {
    code: "W08-CON",
